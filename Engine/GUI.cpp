...
StatisticGUI::StatisticGUI(Coordinator* coordinator,Entity* entity, sf::Font font)
{
	...
	exp_bar = Bar(sf::Color(40, 40, 255, 255), sf::Color(0, 0, 0, 0), sf::Vector2f(30, 5), shape_rect, sf::Vector2f(0, -10), e_stats.max_expierence, e_stats.expirence, false);
